...
#Runtime comparison of paraR to micropan

Below we an example of optimized runtime of **pasaR** functions to corresponding to **micropan**. We calculate fluidity with 100 simulations.


* Fluidity
```{r, echo=FALSE}
microbenchmark(fluidity(panm, n.sim = 100))

microbenchmark(pm_fluidity(panm,, n.sim = 100))
```
